...
RegisterNetEvent('dispatch:methalert')
AddEventHandler('dispatch:methalert', function()
    local eventId = uuid()
    local dispatchCode = "10-31M"
    local street1 = GetStreetAndZone()
    local gender = IsPedMale(PlayerPedId())
    local plyPos = GetEntityCoords(PlayerPedId(), true)
    TriggerServerEvent('dispatch:svNotify', {
...
RegisterNetEvent('dispatch:fibrob')
AddEventHandler('dispatch:fibrob', function()
    local eventId = uuid()
    local dispatchCode = "Shoot-on-sight"
    local street1 = GetStreetAndZone()
    local gender = IsPedMale(PlayerPedId())
    local plyPos = GetEntityCoords(PlayerPedId(), true)
    TriggerServerEvent('dispatch:svNotify', {
